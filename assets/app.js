...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DashboardPage = __webpack_require__(231);

	var _DashboardPage2 = babelHelpers.interopRequireDefault(_DashboardPage);

	var _ContentPage = __webpack_require__(247);

	var _ContentPage2 = babelHelpers.interopRequireDefault(_ContentPage);

	/// <reference path="../typings/main.d.ts" />

	ReactDom.render(React.createElement(_reactRouter.Router, { history: _reactRouter.browserHistory }, React.createElement(_reactRouter.Route, { path: "/", component: _App2.default }, React.createElement(_reactRouter.IndexRoute, { component: _DashboardPage2.default }), React.createElement(_reactRouter.Route, { path: "/content", component: _ContentPage2.default }))), document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommonActionCreators = __webpack_require__(221);

	var CommonActionCreators = babelHelpers.interopRequireWildcard(_CommonActionCreators);

	var _BaseComponent2 = __webpack_require__(230);
	...
	var _NavLink2 = babelHelpers.interopRequireDefault(_NavLink);
	...
	var App = function (_BaseComponent) {
	    ...
	    App.prototype.doRender = function doRender() {
	        return React.createElement("div", { id: "container" }, React.createElement(_DashboardPage2.default, null), React.createElement(_NavLink2.default, { to: "/content" }, "Content"), this.props.children);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppLoadedAction = __webpack_require__(226);

	var _AppLoadedAction2 = babelHelpers.interopRequireDefault(_AppLoadedAction);

	var _SayHelloAction = __webpack_require__(228);

	var _SayHelloAction2 = babelHelpers.interopRequireDefault(_SayHelloAction);

	var _ShowDashboardAction = __webpack_require__(229);

	var _ShowDashboardAction2 = babelHelpers.interopRequireDefault(_ShowDashboardAction);
	...
	function showDashboard() {
	    _Dispatcher2.default.dispatch(new _ShowDashboardAction2.default(2, "Joris"));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionLogEntry = __webpack_require__(227);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShowDashboardAction = function () {
	    function ShowDashboardAction(goalsFinished, username) {
	        babelHelpers.classCallCheck(this, ShowDashboardAction);

	        this.goalsFinished = goalsFinished;
	        this.username = username;
	    }

	    ShowDashboardAction.prototype.toLogEntry = function toLogEntry() {
	        return new _ActionLogEntry2.default("ShowDashboardAction", {
	...
	exports.default = ShowDashboardAction;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SmartComponent2 = __webpack_require__(232);

	var _SmartComponent3 = babelHelpers.interopRequireDefault(_SmartComponent2);

	var _DashboardStore = __webpack_require__(233);

	var _DashboardStore2 = babelHelpers.interopRequireDefault(_DashboardStore);

	var _DashboardHeader = __webpack_require__(235);

	var _DashboardHeader2 = babelHelpers.interopRequireDefault(_DashboardHeader);

	var _DashboardSettingsBar = __webpack_require__(240);

	var _DashboardSettingsBar2 = babelHelpers.interopRequireDefault(_DashboardSettingsBar);

	var DashboardPage = function (_SmartComponent) {
	    babelHelpers.inherits(DashboardPage, _SmartComponent);

	    function DashboardPage() {
	        babelHelpers.classCallCheck(this, DashboardPage);
	        return babelHelpers.possibleConstructorReturn(this, _SmartComponent.call(this, _DashboardStore2.default));
	    }

	    DashboardPage.prototype.componentDidMount = function componentDidMount() {
	        _SmartComponent.prototype.componentDidMount.call(this);
	        // Trigger load item action
	    };

	    DashboardPage.prototype.doRender = function doRender() {
	        return React.createElement("div", null, React.createElement(_DashboardHeader2.default, null), React.createElement(_DashboardSettingsBar2.default, null));
	    };

	    DashboardPage.prototype.getState = function getState() {
	        return {
	            goalsFinished: _DashboardStore2.default.getGoalsFinished(),
	            username: _DashboardStore2.default.getUsername()
	        };
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseStore2 = __webpack_require__(234);
	...
	var DashboardStore = function (_BaseStore) {
	    babelHelpers.inherits(DashboardStore, _BaseStore);

	    function DashboardStore() {
	        babelHelpers.classCallCheck(this, DashboardStore);

	        var _this = babelHelpers.possibleConstructorReturn(this, _BaseStore.call(this));

	        _this.goalsFinished = 0;
	    ...
	    DashboardStore.prototype.getGoalsFinished = function getGoalsFinished() {
	        return this.goalsFinished;
	    };

	    DashboardStore.prototype.getUsername = function getUsername() {
	        return this.username;
	    };

	    DashboardStore.prototype.processActions = function processActions(action) {
	        if (action instanceof _ShowDashboardAction2.default) {
	...
	exports.default = new DashboardStore();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DashboardHeader = function (_BaseComponent) {
	    babelHelpers.inherits(DashboardHeader, _BaseComponent);

	    function DashboardHeader() {
	        babelHelpers.classCallCheck(this, DashboardHeader);
	        return babelHelpers.possibleConstructorReturn(this, _BaseComponent.apply(this, arguments));
	    }

	    DashboardHeader.prototype.doRender = function doRender() {
	        return React.createElement("div", { className: styles.dashboardHeader }, "some content");
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?minimize&modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../../../node_modules/less-loader/index.js?-compress!./DashboardHeader.module.less", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?minimize&modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../../../node_modules/less-loader/index.js?-compress!./DashboardHeader.module.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".DashboardHeader-module__dashboardHeader___2Bks_{height:40%;background-color:#1ca398}", ""]);

	// exports
	exports.locals = {
		"dashboardHeader": "DashboardHeader-module__dashboardHeader___2Bks_"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DashboardSettingsBar = function (_BaseComponent) {
	    babelHelpers.inherits(DashboardSettingsBar, _BaseComponent);

	    function DashboardSettingsBar() {
	        babelHelpers.classCallCheck(this, DashboardSettingsBar);
	        return babelHelpers.possibleConstructorReturn(this, _BaseComponent.apply(this, arguments));
	    }

	    DashboardSettingsBar.prototype.doRender = function doRender() {
	        return React.createElement("div", { className: styles.bar }, React.createElement("div", { className: "mdl-bar" }, React.createElement("div", { className: "mdl-cell--8-offset mdl-cell mdl-cell--4-col" }, "yea!")));
	    };

	    return DashboardSettingsBar;
	}(_BaseComponent3.default);

	exports.default = DashboardSettingsBar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?minimize&modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../../../node_modules/less-loader/index.js?-compress!./DashboardSettingsBar.module.less", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?minimize&modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../../../node_modules/less-loader/index.js?-compress!./DashboardSettingsBar.module.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".DashboardSettingsBar-module__bar___2Q5b6{height:10%;background-color:#fff;color:#000}", ""]);

	// exports
	exports.locals = {
		"bar": "DashboardSettingsBar-module__bar___2Q5b6"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavLink = exports.NavLink = function (_BaseComponent) {
	    babelHelpers.inherits(NavLink, _BaseComponent);

	    function NavLink() {
	        babelHelpers.classCallCheck(this, NavLink);
	        return babelHelpers.possibleConstructorReturn(this, _BaseComponent.apply(this, arguments));
	    }

	    NavLink.prototype.doRender = function doRender() {
	        return React.createElement(_reactRouter.Link, __assign({}, this.props, { activeClassName: "active" }));
	    };
	...
	var ContentPage = function (_SmartComponent) {
	    ...
	    ContentPage.prototype.doRender = function doRender() {
	        ...
	        return React.createElement("div", { className: styles.container }, React.createElement(_ContentHeader2.default, { isActive: true, title: headerTitle }), React.createElement(_ContentBody2.default, { ref: "contentBodyRef", title: this.state.bodyTitle, summary: this.state.bodySummary }, React.createElement("div", { className: styles.hello }, React.createElement("button", { onClick: function onClick() {
	            ...
	            } }, "Say Hello!"), React.createElement("span", null, " You said hello ", this.state.sayHelloCount, " time(s)")), React.createElement("button", { onClick: function onClick() {
	    ...
	    ContentPage.prototype.showDashboard = function showDashboard() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ContentHeader-module__container___22yLB{color:#025204;border:1px;background-color:#afdeb0;text-align:center;height:40px;line-height:40px}", ""]);

	// exports
	exports.locals = {
		"container": "ContentHeader-module__container___22yLB"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ContentBody-module__container___3zRP8{background-color:#e6f2e9;height:100%;padding:10px}.ContentBody-module__title___1F1e0{font-size:24px;padding-top:10px;padding-bottom:10px;font-weight:700}.ContentBody-module__summary___ttaml{font-size:20px}.ContentBody-module__summaryTitle___1rV8w{font-weight:700}", ""]);

	// exports
	exports.locals = {
		"container": "ContentBody-module__container___3zRP8",
		"title": "ContentBody-module__title___1F1e0",
		"summary": "ContentBody-module__summary___ttaml",
		"summaryTitle": "ContentBody-module__summaryTitle___1rV8w ContentBody-module__summary___ttaml"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ContentPage-module__container___1pzJo{height:100%}.ContentPage-module__hello___3nZvF{margin-top:40px;font-size:20px;color:red}", ""]);

	// exports
	exports.locals = {
		"container": "ContentPage-module__container___1pzJo",
		"hello": "ContentPage-module__hello___3nZvF"
	};
